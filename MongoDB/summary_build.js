  ...
  [
    ...
    // Stage 2
    {
      $project: { 
      	...
      	, assignments_fp_date: "$details.assignments.fp.job.as_from_full"
      	...
      	, assignments_hr_start_date: "$details.assignments.hr.job.as_from_full"
          , assignments_hr_hours:  "$details.assignments.hr.job.as_total_hours"
    ...
    // Stage 3
    {
      $project: { 
              ...
              "$cond" : {
                  "if" : {
                      "$or" : [
                          {
                              "$eq" : [
                                  "$assignments_fp_listed", 
                                  true
                              ]
                          }, 
                          {
                              "$eq" : [
                                  "$assignments_hr_listed", 
                                  true
                              ]
                          }
                      ]
          ...
          "skills_count" : {
              "$cond" : {
                  "if" : "$skills_list_array", 
                  "then" : {
                      "$size" : "$details.skills.skill"
                  }, 
                  "else" : {
                      "$cond" : {
                          "if" : "$skills_listed", 
          ...
          "experiences_count" : {
              "$cond" : {
                  "if" : "$experiences_list_array", 
                  "then" : {
                      "$size" : "$details.experiences.experience"
                  }, 
                  "else" : {
                      "$cond" : {
                          "if" : "$experiences_listed", 
                          "then" : 1, 
                          "else" : 0
                      }
                  }
          ...
          "categories_subgroup_count" : {
              "$cond" : {
                  "if" : "$categories_subgroup_list_array", 
                  "then" : {
                      "$size" : "$details.dev_job_categories_v2.dev_job_categories_v"
                  }, 
                  "else" : {
                      "$cond" : {
          ...
          "assignments_fp_count" : {
              "$cond" : {
                  "if" : "$assignments_fp_list_array", 
                  "then" : {
                      "$size" : "$details.assignments.fp.job"
                  }, 
                  "else" : {
                      "$cond" : {
                          "if" : "$assignments_fp_listed", 
                          "then" : 1, 
                          "else" : 0
                      }
                  }
          ...
          "assignments_hr_count" : {
              "$cond" : {
                  "if" : "$assignments_hr_list_array", 
                  "then" : {
                      "$size" : "$details.assignments.hr.job"
                  }, 
                  "else" : {
                      "$cond" : {
                          "if" : "$assignments_hr_listed", 
                          "then" : 1, 
                          "else" : 0
                      }
                  }
          ...
          "education_count" : {
              "$cond" : {
                  "if" : "$education_list_array", 
                  "then" : {
                      "$size" : "$details.education.institution"
                  }, 
                  "else" : {
                      "$cond" : {
                          "if" : "$education_listed", 
